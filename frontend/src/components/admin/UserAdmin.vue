      ...
      <b-row>
        ...
        <b-col md="6" sm="12">
          <b-form-group label="E-mail:" label-for="user-email">
            <b-form-input id="user-email" type="email" v-model="user.email" placeholder="Informe o E-mail do Usuário" required :readonly="mode === 'remove'" />
          </b-form-group>
        </b-col>
      </b-row>
      <b-form-checkbox id="user-admin" v-model="user.admin" class="mt-3 mb-3" v-show="mode !== 'remove'">
        Administrador ?
      </b-form-checkbox>
      <b-row v-show="mode !== 'remove'">
        ...
        <b-col md="6" sm="12">
          <b-form-group label="Confirmação de senha:" label-for="user-confirmPassword">
            <b-form-input id="user-confirmPassword" type="password" v-model="user.confirmPassword" placeholder="Confirme a Senha do Usuário" required />
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
